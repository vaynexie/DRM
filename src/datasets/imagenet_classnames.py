...
subset_names=['tench', 'great white shark', 'indigo bunting', 'agama', 'American alligator', 'water snake', 'black grouse', 'ptarmigan', 'ruffed grouse', 'sulphur-crested cockatoo', 'coucal', 'hummingbird', 'platypus', 'koala', 'grey whale', 'leopard', 'sloth bear', 'bee', 'stick insect', 'small white butterfly', 'sulphur butterfly', 'fox squirrel', 'hartebeest', 'three-toed sloth', 'howler monkey', 'indri', 'snoek fish', 'sturgeon', 'gar fish', 'academic gown', 'bakery', 'balance beam', 'Band-Aid', 'barbershop', 'barn', 'swimming cap', 'bath towel', 'bathtub', 'beer bottle', 'bikini', 'bookstore', 'bulletproof vest', 'high-speed train', 'chain mail', 'chainsaw', 'cowboy hat', 'cradle', 'dam', 'dog sled', 'dumbbell', 'fireboat', 'flagpole', 'fountain pen', 'freight car', 'gondola', 'hair spray', 'hamper', 'hard disk drive', 'gymnastic horizontal bar', 'lighter', 'miniskirt', 'graduation cap', 'mountain bike', 'neck brace', 'baby pacifier', 'obelisk', 'ocarina', 'padlock', 'parallel bars', 'patio', 'pencil case', 'pill bottle', 'ping-pong ball', 'plastic bag', 'plunger', 'pole', 'soda bottle', 'plant pot', "potter's wheel", 'hockey puck', 'quill', 'racket', 'radio telescope', 'rain barrel', 'rotisserie', 'eraser', 'safe', 'saxophone', 'seat belt', 'shoe store', 'shovel', 'shower cap', 'ski', 'sleeping bag', 'snorkel', 'snowmobile', 'snowplow', 'keyboard space bar', 'steel drum', 'stove', 'sunglasses', 'semi-trailer truck', 'volleyball', 'airplane wing', 'cheeseburger', 'baseball player']
