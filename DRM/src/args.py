...
def parse_arguments():
    ...
    parser.add_argument(
        "--csv-region-caption-key",
        type=str,
        default="rtitle",
        help="For csv-like datasets, the name of the key for the region captions.")
    parser.add_argument(
        "--csv-caption-key",
        type=str,
        default="title",
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to concept description file",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=0.5,
        help="Final output = beta*default prompt classifier output + (1-beta)*concept description prompt clasisifier output",
    )
